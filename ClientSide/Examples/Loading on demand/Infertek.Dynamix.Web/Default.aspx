...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
	<script type="text/javascript">
		$(document).ready(function () {
			window.Infertek.ScriptManager.LoadScripts(['/Scripts/Infertek/Common/Exceptions.js',
					'/Scripts/Infertek/Animations/PropertyValueAnimators.js',
					'/Scripts/Infertek/Animations/FrameBlendingFunctions.js',
					'/Scripts/Infertek/Animations/AnimationKeyframe.js',
					'/Scripts/Infertek/Animations/AnimationProperty.js',
					'/Scripts/Infertek/Animations/Animation.js'], function () {
